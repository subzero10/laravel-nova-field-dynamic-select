...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm.dynamicField.multiselect
        ? _c(
            "panel-item",
            { attrs: { field: _vm.dynamicField } },
            [
              _c("template", { slot: "value" }, [
                _vm.dynamicField.value.length
                  ? _c(
                      "div",
                      {
                        staticClass:
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "overflow-hidden rounded-b-lg rounded-t-lg"
                          },
                          _vm._l(_vm.dynamicField.value, function(option, i) {
                            return _c(
                              "div",
                              {
                                key: i,
        ...
        : _c("panel-item", { attrs: { field: _vm.dynamicField } })
    ],
    1
  )
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        if (this.field.dependsOn) {
            this.field.dependsOn.forEach(function (item) {
                var dependsOn = this.checkForNestedForm() ? this.addNestedFormPrefix() : this.addFlexibleContentPrefix(item, this.field);
    ...
    methods: {
         ...
         */
        checkForNestedForm: function checkForNestedForm() {
         ...
         */
        addNestedFormPrefix: function addNestedFormPrefix() {
            ...
            if (this.field.multiselect) {
                if (this.value && this.value.length) {
                    this.value.forEach(function (v, i) {
                        formData.append(_this2.field.attribute + '[' + i + ']', JSON.stringify(v));
                    });
                } else {
                    formData.append(this.field.attribute, '');
                }
            } else {
                formData.append(this.field.attribute, typeof this.value == 'undefined' || !this.value ? '' : this.value.value);
            }
        },
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                if (this.value) {
                                    this.value = this.options.find(function (item) {
                                        return item['value'] == _this3.value['value'];
                                    });
                                }
        ...
        [
          _c("multiselect", {
            attrs: {
              ...
              selectLabel: _vm.field.selectLabel,
              deselectLabel: _vm.field.deselectLabel,
              selectedLabel: _vm.field.selectedLabel
            },
